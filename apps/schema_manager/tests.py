...
TABLE_ENDPOINT = "/api/table"
TABLE_UPDATE_ENDPOINT = "/api/table/<table_id>"
...
class TestDynamicTableCreate(ApiTestCase):
    def test_allowed_methods(self):
        ...
        for method in ("put", "get", "patch"):
            ...
            resp = request_method(TABLE_ENDPOINT, payload, format="json")
            self.assertEqual(resp.status_code, 405)

    def test_normal_post(self):
        self.assertEqual(DynamicTable.objects.count(), 0)
        payload = valid_payload_factory()
        resp = self.api_client.post(TABLE_ENDPOINT, payload, format="json")
        ...
        self.api_client.post(TABLE_ENDPOINT, payload, format="json")
...
class TestDynamicTableUpdate(ApiTestCase):
    def test_add_alter_delete(self):
        ...
        resp = self.api_client.put(TABLE_UPDATE_ENDPOINT.replace("<table_id>", str(table_id)), payload, format="json")
        ...
        self.api_client.put(TABLE_UPDATE_ENDPOINT.replace("<table_id>", str(table_id)), payload, format="json")
